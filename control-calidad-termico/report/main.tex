...
Buscamos obtener el coeficiente de enfriamiento k a partir de 21 temperaturas simuladas, registradas cada
minuto durante los primeros 20 minutos. Con ese valor construimos la función \(T(t)\), calculamos el tiempo necesario para llegar a \(27\,^{\circ}\mathrm{C}\) y comprobamos el resultado resolviendo la ecuación diferencial. También analizamos qué cambia si el taller está a \(24\,^{\circ}\mathrm{C}\).
