...
\title{
    \vspace{0.8in}
    \IfFileExists{logo tec.png}{\includegraphics[width=0.30\textwidth]{logo tec.png}\\\vspace{0.4cm}}{}
...
Flor Denisse Hinojosa Hernández\\[0.30cm]
...
En este ejercicio modelamos el enfriamiento de un eje de acero después de salir del horno de templado. La pieza comienza a \(97\,^{\circ}\mathrm{C}\) y se deja enfriar en un taller que se mantiene a \(18\,^{\circ}\mathrm{C}\). Para manipularla, se toma \(27\,^{\circ}\mathrm{C}\) como temperatura segura.

Buscamos obtener el coeficiente de enfriamiento \(k\) a partir de 21 temperaturas simuladas, registradas cada minuto durante los primeros 20 minutos. Con ese valor construimos la función \(T(t)\), calculamos el tiempo necesario para llegar a \(27\,^{\circ}\mathrm{C}\) y comprobamos el resultado resolviendo la ecuación diferencial. También analizamos qué cambia si el taller está a \(24\,^{\circ}\mathrm{C}\).
...
Usamos la ley de enfriamiento de Newton porque relaciona la rapidez de enfriamiento con la diferencia entre la temperatura de la pieza y la del ambiente \citep{incropera2017}. Para aplicarla suponemos que el taller conserva una temperatura constante, que \(T(t)\) representa una temperatura promedio de todo el eje y que \(k\) no cambia durante la prueba.

Primero linealizamos los datos con \(\ln(T-\Tamb)\) para estimar \(k\). Después resolvemos la ecuación diferencial con la condición inicial exacta y comparamos los tiempos para verificar que ambos procedimientos describan el mismo enfriamiento.

\section{Desarrollo}

\subsection{Datos registrados}

El enunciado pide trabajar con datos generados para simular las lecturas de un pirómetro. Usamos los 21 valores de la Tabla~\ref{tab:datos}; no son mediciones tomadas en una planta. La temperatura baja de \(97.0\,^{\circ}\mathrm{C}\) a \(20.6\,^{\circ}\mathrm{C}\) en 20 minutos. Como a los 13 minutos todavía está en \(27.6\,^{\circ}\mathrm{C}\) y a los 14 minutos ya bajó a \(25.8\,^{\circ}\mathrm{C}\), desde la tabla esperamos que el cruce por \(27\,^{\circ}\mathrm{C}\) ocurra entre esos dos tiempos.
...
La regresión da \(13.14\) minutos y la comprobación analítica da \(13.03\) minutos. La diferencia es
...
Seguimos el mismo proceso de separación:
...
El cambio no consiste solamente en reemplazar 18 por 24. Cerca de la temperatura segura, la pieza está apenas \(3\,^{\circ}\mathrm{C}\) por encima del nuevo ambiente, en lugar de \(9\,^{\circ}\mathrm{C}\) por encima del ambiente original. Con una diferencia térmica menor, el enfriamiento se vuelve más lento antes de llegar a \(27\,^{\circ}\mathrm{C}\).
...
En la Figura~\ref{fig:comparacion-escenarios} vemos el efecto sobre todo cerca de la línea de \(27\,^{\circ}\mathrm{C}\): el caso de \(18\,^{\circ}\mathrm{C}\) la cruza a los \(13.03\) minutos y el de \(24\,^{\circ}\mathrm{C}\) a los \(19.15\) minutos. Bajo el supuesto de conservar \(k\), el cambio de ambiente añade \(6.12\) minutos.

\section{Conclusión e interpretación}

Obtuvimos \(k=0.166700\,\mathrm{min}^{-1}\). Con el ambiente a \(18\,^{\circ}\mathrm{C}\), la regresión indica que el eje llega a \(27\,^{\circ}\mathrm{C}\) a los \(13.14\) minutos; la comprobación analítica da \(13.03\) minutos. Si el ambiente sube a \(24\,^{\circ}\mathrm{C}\) y conservamos el mismo \(k\), la función cambia a \(T(t)=24+73e^{-0.166700t}\) y el tiempo aumenta a \(19.15\) minutos.

Los resultados tienen sentido físico. La pieza pierde temperatura con mayor rapidez al inicio, cuando está mucho más caliente que el taller, y el enfriamiento se hace más lento al reducirse esa diferencia. A largo plazo, \(\displaystyle \lim_{t\to\infty}(\Tamb+Ce^{-kt})=\Tamb\); la solución se acerca al ambiente y no sigue disminuyendo por debajo de él. En el escenario de \(24\,^{\circ}\mathrm{C}\), esa cercanía con la temperatura segura explica los \(6.12\) minutos adicionales.
